...
public class ListasGeneralesModel {
    ...
    List<FormaPagoModel>listFormaPagoModel;
    ...
    public ListasGeneralesModel(List<TipoIdentificacionModel> lisTipoIdentificacionModels, List<GeneroModel> lisGeneroModels, List<ProfesionesModel> lisProfesionesModels, List<EstadoCivilModel> lisEstadoCivilModels, List<TipoSolicitudModel> lisTipoSolicitudModels, List<CategoriaSisbenModel> lisCategoriaSisbenModels, List<CiudadModel> lisCiudadModels, List<MediosMasivosModel> lisMediosMasivosModels, List<NivelEstudiosModel> lisNivelEstudiosModels, List<TipoSanguineoModel> listipoSanguineoModels, List<UniversidadesModel> lisUniversidadesModels, List<NivelFormacionModel> listNivelFormacionModels, List<GrupoProgramasModel> listGrupoProgramasModels, List<ProgramasModel> listProgramasModels, List<CentroAsociadoModel> listCentroAsociadoModels, List<ComunidadModel> listComunidadModels, List<TiposEpsModel> listTiposEpsModel, List<FormaPagoModel> listFormaPagoModel, List<PeriodoAcademicoModel> listPeriodoAcademico) {
        ...
        this.listTiposEpsModel = listTiposEpsModel;
        this.listFormaPagoModel = listFormaPagoModel;
    ...
    public List<TiposEpsModel> getTiposEpsModel() {
        return listTiposEpsModel;
    }

    public void setTiposEpsModel(List<TiposEpsModel> listTiposEpsModel) {
        this.listTiposEpsModel = listTiposEpsModel;
    }

    public List<TiposEpsModel> getListTiposEpsModel() {
        return listTiposEpsModel;
    }

    public void setListTiposEpsModel(List<TiposEpsModel> listTiposEpsModel) {
        this.listTiposEpsModel = listTiposEpsModel;
    }

    public List<FormaPagoModel> getListFormaPagoModel() {
        return listFormaPagoModel;
    }

    public void setListFormaPagoModel(List<FormaPagoModel> listFormaPagoModel) {
        this.listFormaPagoModel = listFormaPagoModel;
    }

    public List<PeriodoAcademicoModel> getListPeriodoAcademico() {
        return listPeriodoAcademico;
    }

    public void setListPeriodoAcademico(List<PeriodoAcademicoModel> listPeriodoAcademico) {
        this.listPeriodoAcademico = listPeriodoAcademico;
    }
